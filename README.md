...
**UPD2: Описание неактуальных скриптов перемещено в [oldScriptReadme.md](https://github.com/KonstantinAlexeevich/autoXRAY/blob/main/old/oldScriptReadme.md).**
...
bash -c "$(curl -L https://raw.githubusercontent.com/KonstantinAlexeevich/autoXRAY/main/autoXRAY1.sh)" -- вашДОМЕН.com
```
...
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/KonstantinAlexeevich/autoXRAY/main/autoXRAY1.sh)" -- поддомен1.вашДОМЕН.com

```
2) На ru VPS ставим новый скрипт (здесь нам понадобится vless XHTTP reality EXTRA конфиг №1):
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/KonstantinAlexeevich/autoXRAY/main/autoXRAYselfRUbrEUxhttp.sh)" -- поддомен2.вашДОМЕН.com "vless://вашКонфигXHTTP"
```
...
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/KonstantinAlexeevich/autoXRAY/main/old/autoXRAYselfstealConfRUbrEU.sh)" -- поддомен2.вашДОМЕН.com "vless://вашКонфигRAW"
```
Также теперь можно использовать несколько xhttp конфигов, все они будут добавлены в мост.

```bash
bash -c "$(curl -L https://raw.githubusercontent.com/KonstantinAlexeevich/autoXRAY/main/autoXRAYselfRUbrEUxhttp.sh)" -- поддомен2.вашДОМЕН.com "vless://xhttp1" "vless://xhttp2" "vless://xhttp3"
```
...
**Если возникла ошбика при установке WARP** - [читайте инструкцию.](https://github.com/KonstantinAlexeevich/autoXRAY/blob/main/test/warp-readme.md)
